 ...
 */
package com.ps.odl.cli.commands;
...
public class OdltoasterCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OdltoasterCliTestCommand.class);
    protected final OdltoasterCliCommands service;

    public OdltoasterCliTestCommand(final OdltoasterCliCommands service) {
